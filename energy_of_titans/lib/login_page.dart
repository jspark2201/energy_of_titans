...
//                    color: Colors.purple,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                          ...
                          child: Text('계정 입력', style: TextStyle(fontSize: 20),)),
                      Container(
                      ...
                      Text('비밀번호를 잊으셨습니까?', style: TextStyle(color: Colors.blueAccent),),
                      RaisedButton(
                ...
                Container(
                    ...
                    child: Text('계정 등록하기', style: TextStyle(color: Colors.blueAccent),)),
              ],
            ),
          ),
        ),
