...
class MorningWritePage extends StatefulWidget {
  @override
  _MorningWritePageState createState() => _MorningWritePageState();
}

Size _size;

class _MorningWritePageState extends State<MorningWritePage> {
           ...
           Container(
             decoration: BoxDecoration(
                 image: DecorationImage(
                     image: AssetImage('assets/morning.png'), fit: BoxFit.cover)),
           ),
           BackdropFilter(
...
//                  color: Colors.yellow,
            child: Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text('타이탄454 님!\n\n당신을 즐겁게 하는 인물이 있나요?', style: TextStyle(color: Colors.black, fontSize: 24.0),),
            ),
          ),
        ),
        Expanded(
...
//                  color: Colors.yellow,
            child: Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text('타이탄454 님!\n\n당신을 즐겁게 하는 물건이 있나요?', style: TextStyle(color: Colors.black, fontSize: 24.0),),
            ),
          ),
        ),
        Expanded(
...
//                  color: Colors.yellow,
            child: Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text('타이탄454 님!\n\n오늘 할 일은 무엇인가요?', style: TextStyle(color: Colors.black, fontSize: 24.0),),
            ),
          ),
        ),
        Expanded(
